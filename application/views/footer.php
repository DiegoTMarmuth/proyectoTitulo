...
<?php if (isset($include_plugin)) {
	foreach ($include_plugin as $plugin) {
		if (strpos($plugin, '.js')) { ?>
			<script type="text/javascript" src="<?php echo base_url() . PLUGIN . $plugin; ?>"></script>
		<?php } elseif (strpos($plugin, '.css')) { ?>
			<link rel="stylesheet" type="text/css" href="<?php echo base_url() . PLUGIN . $plugin; ?>">
<?php  }
	}
} ?>
